...
$routes->group('diskon', ['filter' => 'auth:admin'], function($routes){
    $routes->get('/', 'Admin\DiskonController::index');                  // Halaman utama
    $routes->post('store', 'Admin\DiskonController::store');            // Tambah data
    $routes->post('update/(:num)', 'Admin\DiskonController::update/$1'); // Edit data
    $routes->post('delete/(:num)', 'Admin\DiskonController::delete/$1'); // Hapus data (pakai form POST)
});
